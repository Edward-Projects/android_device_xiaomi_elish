...
BOARD_PREBUILT_VENDORIMAGE := $(ELISH_PREBUILT)/vendor.img

BOARD_ELISH_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor
BOARD_SUPER_PARTITION_SIZE := 9126805504
BOARD_SUPER_PARTITION_GROUPS := elish_dynamic_partitions
BOARD_ELISH_DYNAMIC_PARTITIONS_SIZE := 9122611200
...
BOARD_PARTITION_LIST := $(call to-upper, $(BOARD_ELISH_DYNAMIC_PARTITIONS_PARTITION_LIST))
